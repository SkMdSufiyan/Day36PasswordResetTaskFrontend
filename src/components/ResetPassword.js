...
const ResetPassword = () => {
  ...
  const emptyUserNewCredErrors = {
    "emailError" : "",
    "newPasswordError" : "",
    "confirmNewPasswordError" : "Password and confirm password should match"
  };
        ...
        <Card style={{width: '18rem'}}>
            ...
            {isTokenValid && ! apiCallError && ! isResetPasswordSuccess ? (
              ...
              <div>
                ...
                {userNewCredentials.newPassword && ! userNewCredErrors.newPasswordError ? (
                  <div>
                ...
                <Button color='success' disabled={ 
                  !(userNewCredentials.newPassword !== "" && userNewCredErrors.newPasswordError === "" && userNewCredErrors.confirmNewPasswordError === "") 
                  } className='Button-class' onClick={handleSubmitNewCred}>Submit</Button>
